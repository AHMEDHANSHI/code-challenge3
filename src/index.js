// Your code here
// start a new GET request to get the json-server running on the backend(json-server --watch db.json)
	...
	fetch(myGetRequest)
		...
		.then((data) => {
			...
			data.forEach((movie, index) => {
				...
				// when a user selects a certain movie, update the rest of the data  description accordingly
